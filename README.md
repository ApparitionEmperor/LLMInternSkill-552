...
```bash
git clone https://github.com/ApparitionEmperor/LLMInternSkill-552.git
cd LLMInternSkill-552
python setup.py
```
...
git clone https://github.com/ApparitionEmperor/LLMInternSkill-552 ~/.codex/skills/llm-intern-skill
```
...
<!-- Last updated: 2026-06-06 15:14:22 -->
